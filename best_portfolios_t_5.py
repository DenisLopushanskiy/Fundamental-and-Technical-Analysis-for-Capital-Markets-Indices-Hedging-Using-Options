...
from days_to_exec import dates_tuple
from capital import create_portfolio
#%%
def EMA_best_portfolios(listWithParams, clPrSeries, countrynum, R, T, F,  sigma,daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit):
     ...
     datesTuple = dates_tuple(eMACond, daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit)
...
#%%
def AD_best_portfolios(listWithParams, hgPrSeries, lwPrSeries, countrynum, R, T, F,  sigma, daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit, eMABestPortfoliosDF):
     ...
     datesTuple = dates_tuple(aDCond, daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit)
     daysToRenewMatrix[:,0] = datesTuple[0]
     daysToSellMatrix[:,0] = datesTuple[1]
     daysToHoldMatrix[:,0] = datesTuple[2]
     putATM = PutOpt(100, 0.2, 'long', countrynum).option_price(R, T, F, sigma, datesTuple[0], datesTuple[1], datesTuple[3])
...
#%%
def KAMA_best_portfolios(listWithParams, clPrSeries, countrynum, R, T, F,  sigma, daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit, aDBestPortfoliosDF):
     '''Calculates portfolios with previously calculated portfolios (here from EMA condition) and options for each option strategy with best parameters (calculated earlier in condition_type module) and takes list of best parameters as inputs.
     :listWithParams: list of lists with pairs of parameters (7 pairs). Each pair is later used to its own strategy (i.e. pair with index 0 is for putATM strategy)
     :clPrSeries: is used for TA calculation
     :No FA conditions are required:
     ...
     datesTuple = dates_tuple(kAMACond, daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit)
     daysToRenewMatrix[:,0] = datesTuple[0]
     daysToSellMatrix[:,0] = datesTuple[1]
     daysToHoldMatrix[:,0] = datesTuple[2]
     putATM = PutOpt(100, 0.2, 'long', countrynum).option_price(R, T, F, sigma, datesTuple[0], datesTuple[1], datesTuple[3])
...
#%%
def MACD_best_portfolios(listWithParams, clPrSeries, countrynum, R, T, F,  sigma, daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit, kAMABestPortfoliosDF):
     '''Calculates portfolios with previously calculated portfolios (here from EMA condition) and options for each option strategy with best parameters (calculated earlier in condition_type module) and takes list of best parameters as inputs.
     :listWithParams: list of lists with pairs of parameters (7 pairs). Each pair is later used to its own strategy (i.e. pair with index 0 is for putATM strategy)
     :clPrSeries: is used for TA calculation
     :No FA conditions are required:
     ...
     datesTuple = dates_tuple(mACDCond, daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit)
     daysToRenewMatrix[:,0] = datesTuple[0]
     daysToSellMatrix[:,0] = datesTuple[1]
     daysToHoldMatrix[:,0] = datesTuple[2]
     putATM = PutOpt(100, 0.2, 'long', countrynum).option_price(R, T, F, sigma, datesTuple[0], datesTuple[1], datesTuple[3])
...
#%%
def TRIX_best_portfolios(listWithParams, clPrSeries, countrynum, R, T, F,  sigma, daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit, mACDBestPortfoliosDF):
     '''Calculates portfolios with previously calculated portfolios (here from EMA condition) and options for each option strategy with best parameters (calculated earlier in condition_type module) and takes list of best parameters as inputs.
     :listWithParams: list of lists with pairs of parameters (7 pairs). Each pair is later used to its own strategy (i.e. pair with index 0 is for putATM strategy)
     :clPrSeries: is used for TA calculation
     :No FA conditions are required:
     ...
     datesTuple = dates_tuple(tRIXCond, daysTillExpirationTr, daysOfExpirationTr, daysToRenewInit)
     daysToRenewMatrix[:,0] = datesTuple[0]
     daysToSellMatrix[:,0] = datesTuple[1]
     daysToHoldMatrix[:,0] = datesTuple[2]
     putATM = PutOpt(100, 0.2, 'long', countrynum).option_price(R, T, F, sigma, datesTuple[0], datesTuple[1], datesTuple[3])
